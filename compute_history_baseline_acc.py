...
with open('./results/book_history/graphsage_5tp_5token_children_new_model_labels.txt', 'r') as f:
    eval_decode_label = json.load(f)

with open('./results/book_history/graphsage_5tp_5token_children_new_model_results.txt', 'r') as f:
