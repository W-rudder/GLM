...
with open('./results/sports/graphsage_5tp_5token_mix_LP_model_labels.txt', 'r') as f:
    eval_decode_label = json.load(f)

with open('./results/sports/graphsage_5tp_5token_mix_LP_model_results.txt', 'r') as f:
