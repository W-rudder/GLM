...
with open('./results/photo/graphsage_5tp_5token_lr_model_labels.txt', 'r') as f:
    eval_decode_label = json.load(f)

with open('./results/photo/graphsage_5tp_5token_lr_model_results.txt', 'r') as f:
    eval_pred = json.load(f)

# with open('./results/photo/graphsage_0tp_5token_512_neg0_computer_2_3400_more_epoch_photo_baseline1_model_labels.txt', 'r') as f:
#     eval_decode_label = json.load(f)

# with open('./results/photo/graphsage_0tp_5token_512_neg0_computer_2_3400_more_epoch_photo_baseline1_model_results.txt', 'r') as f:
#     eval_pred = json.load(f)
