...
with open('./results/photo/graphsage_1000tp_5token_256_neg1_computer_1_1432_model_labels.txt', 'r') as f:
    eval_decode_label = json.load(f)

with open('./results/photo/graphsage_1000tp_5token_256_neg1_computer_1_1432_model_results.txt', 'r') as f:
